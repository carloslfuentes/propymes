PROPYMES::Application.routes.draw do
  ...
  resources :configurations do
    collection do
      get :add_permissions_user
      post :create_permission_user
      get :associate_assistant_doctor
      post :create_associate
      get :home
    end
  end
  resources :webservices do
    collection do
      get :check_time_limit
    end
  end
  ...
  resources :patients do
    resources :consults do
      member do
        get :print_prenscription
        post :create_documents
      end
    end
    collection do
      get :get_patient_for_medic
    end
  end
  resources :cites do
    collection do
